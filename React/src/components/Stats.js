...
const repositories = [
  {
    ...
    value: "Stars",
    images: [
      { url: "./static/forecast_fig3.png", title: "A Bar Chart to plot the stars for every Repo" },
    ],
  },
  {
    key: "Forks",
    value: "Forks",
    images: [
      { url: "./static/forks.png", title: "A Bar Chart to plot the forks for every Repo" },
    ],
  },
  {
    key: "Stack",
    value: "Stack Graph",
    images: [
      { url: "./static/stack.png", title: "A Stack-Bar Chart to plot the created and closed issues for every Repo" },
    ],
  },
];
